...
export default function SeparatedTabsDemo() {
  return (
    <Tabs defaultValue="followers" className="max-w-xs w-full">
      <TabsList className="w-full grid grid-cols-2 p-0 bg-background rounded-none h-auto gap-x-2">
        <TabsTrigger
          value="followers"
          className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-none py-1.5 rounded-md hover:bg-secondary"
        >
          Followers
        </TabsTrigger>
        <TabsTrigger
